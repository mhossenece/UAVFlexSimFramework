...
dataLW1 = readtable('LW1_log.csv'); % for LW1
dataLW2 = readtable('LW2_log.csv'); % for LW2
dataLW3 = readtable('LW3_log.csv'); % for LW3
dataLW4 = readtable('LW4_log.csv'); % for LW4
...
% timeLW1 = datetime(timeLW1, 'InputFormat', 'yyyy-MM-dd HH:mm:ss.SSS');
% timeLW2 = datetime(timeLW2, 'InputFormat', 'yyyy-MM-dd HH:mm:ss.SSS');
% timeLW3 = datetime(timeLW3, 'InputFormat', 'yyyy-MM-dd HH:mm:ss.SSS');
% timeLW4 = datetime(timeLW4, 'InputFormat', 'yyyy-MM-dd HH:mm:ss.SSS');
% 
% % Convert datetimes to seconds from start for LW1, LW2, LW3, and LW4
% timeSecondsLW1 = seconds(timeLW1 - timeLW1(1));
% timeSecondsLW2 = seconds(timeLW2 - timeLW2(1));
% timeSecondsLW3 = seconds(timeLW3 - timeLW3(1));
% timeSecondsLW4 = seconds(timeLW4 - timeLW4(1));
% 
% % Plot Time vs RSRP for LW1, LW2, LW3, and LW4
% figure;
% %subplot(2, 1, 1);
% plot(timeSecondsLW1, rsrpLW1, 'b-', 'LineWidth', 2);
% hold on;
% plot(timeSecondsLW2, rsrpLW2, 'r-', 'LineWidth', 2);
% plot(timeSecondsLW3, rsrpLW3, 'g-', 'LineWidth', 2);
% plot(timeSecondsLW4, rsrpLW4, 'm-', 'LineWidth', 2);
% title('Time vs RSRP measured in Matlab Simulation');
% xlabel('Time (s)');
% ylabel('RSRP (dBm)');
% legend('LW1', 'LW2', 'LW3', 'LW4');
% grid on;
...
%legend('LW1', 'LW2', 'LW3', 'LW4', 'Location', 'north');
...
print(gcf, 'fixed_distance_rsrp_simulation.pdf', '-dpdf', '-r300', '-bestfit');
%print(gcf, 'fixed_distance_rsrp_simulation.png', '-dpng', '-r300');
%saveas(gcf, 'fixed_distance_rsrp_simulation.fig');
