...
cb.Label.Position = cb.Label.Position + [-2 -11.5 0]; % Adjust the position
...
%cb.Label.String = 'dBm';
cb.Label.Rotation = rotation; % Make the text horizontal
cb.Label.Position = cb.Label.Position + [-2 -6.3 0]; % Adjust the position
...
print(gcf, 'fixed_rsrp_simulation.pdf', '-dpdf', '-r300', '-bestfit');
