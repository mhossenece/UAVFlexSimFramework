...
cb.Label.Rotation = rotation; % Make the text horizontal
%cb.Label.FontSize = 6;
cb.Label.Position = cb.Label.Position + [-2 -10.5 0]; % Adjust the position
...
%cb.Label.String = 'dBm';
cb.Label.Rotation = rotation; % Make the text horizontal
cb.Label.Position = cb.Label.Position + [-2 -7.3 0]; % Adjust the position
...
print(gcf, 'fixed_rsrp_emulation.pdf', '-dpdf', '-r300', '-bestfit');
